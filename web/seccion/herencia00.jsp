...
<section style="padding-top: 6em">
    ...
    <div class="row">
        <div class="6u 12u(medium)">
            <p class="text-justify">La herencia es una característica principal de la programación orientada a objetos (POO), la cual es una forma de reutilización de software, donde para crear una nueva clase se toman o adquieren los atributos y métodos de una clase existente y se mejoran con capacidades nuevas. 
                La reutilización de software ahorra tiempo durante la etapa de desarrollo. De igual forma, fomenta la utilización de código probado y depurado, lo cual aumenta la probabilidad de que el sistema se implemente de forma efectiva.</p>
        </div>
